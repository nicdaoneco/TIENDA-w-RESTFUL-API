...
import 'package:TIENDA/Uproduct.dart';
import 'package:TIENDA/allproduct.dart';
import 'package:TIENDA/note.dart';
import 'package:http/http.dart' as http;
import 'package:flutter/material.dart';

class Canned extends StatefulWidget {
  @override
  _CannedState createState() => _CannedState();
}

class _CannedState extends State<Canned> {
  ...
  Future<List<Product>> _getProduct() async {
    var data = await http.get("http://192.168.0.25:8000/api/products/canned");
